...
public sealed class SettingsResponse
{
    ...
    public SettingsProviders Providers { get; set; } = new();

    [JsonPropertyName("features")]
    public SettingsFeatures Features { get; set; } = new();

    [JsonPropertyName("chunking")]
    public SettingsChunking Chunking { get; set; } = new();

    [JsonPropertyName("retry")]
    public SettingsRetry Retry { get; set; } = new();

    [JsonPropertyName("whisper")]
    public SettingsWhisper Whisper { get; set; } = new();

    [JsonPropertyName("activeAi")]
    public SettingsActiveAi ActiveAi { get; set; } = new();

    [JsonPropertyName("mcpServers")]
    public List<SettingsMcpServer> McpServers { get; set; } = new();

    [JsonPropertyName("watchedFolders")]
    public List<SettingsWatchedFolder> WatchedFolders { get; set; } = new();

    [JsonPropertyName("databaseConnections")]
    public List<SettingsDatabaseConnection> DatabaseConnections { get; set; } = new();
    ...
    public Dictionary<string, List<SettingsEntry>> RemainingByCategory { get; set; } = new();
}
