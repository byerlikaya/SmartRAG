            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="provider-tabs">
                        ...
                        <div class="provider-tab" data-tab="custom">Пользовательский</div>
                    </div>
                                ...
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
    ...
    options.ModelName = "embedding-001";
                        ...
                        <div class="provider-panel" id="custom">
                            <h3>Пользовательский ИИ-провайдер</h3>
                            <div class="code-example">
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="storage-tabs">
                        ...
                        <div class="storage-tab" data-tab="filesystem">Файловая система</div>
                    </div>
                    
                    <div class="storage-content">
                        <div class="storage-panel active" id="qdrant">
                            <h3>Qdrant (Векторная база данных)</h3>
                            <div class="code-example">
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
    options.StorageProvider = StorageProvider.Qdrant;
                                ...
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
    ...
    options.DatabaseId = 0;
                        ...
                        <div class="storage-panel" id="sqlite">
                            <h3>SQLite (Локальная база данных)</h3>
                            <div class="code-example">
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
                                ...
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
    ...
    // Дополнительная конфигурация не требуется
                        ...
                        <div class="storage-panel" id="filesystem">
                            <h3>Файловая система (Локальное хранилище)</h3>
                            <div class="code-example">
                                <pre><code class="language-csharp">services.AddSmartRAG(options =>
{
