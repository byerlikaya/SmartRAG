        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card">
                    ...
                    <p>Otomatik format algılama ile Word, PDF, Excel, metin belgeleri, resim dosyaları ve ses dosyalarını işleyin.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card">
                    ...
                    <h3>Akıllı Sorgu Niyeti</h3>
                    <p>Niyet algılamasına dayalı olarak sorguları otomatik olarak sohbet veya belge aramasına yönlendirir.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card">
