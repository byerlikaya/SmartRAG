...
SmartRAG genişletilebilirlik ve özelleştirme için Strateji Deseni'ni sağlar. Tüm interface'ler `SmartRAG.Interfaces` namespace'inde bulunur. Tam interface tanımları için repository'deki `src/SmartRAG/Interfaces/` dizinini inceleyin.
