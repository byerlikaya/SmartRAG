---
layout: default
title: Gelişmiş Arayüzler
description: Çoklu veritabanı koordinasyonu, şema analizi, ses ve görüntü ayrıştırma arayüzleri
lang: tr
---
...
Tüm interface'ler `SmartRAG.Interfaces` namespace'inde bulunur. Tam interface tanımları için repository'deki `src/SmartRAG/Interfaces/` dizinini inceleyin.
