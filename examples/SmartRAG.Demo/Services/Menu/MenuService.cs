...
╚═══════════════════════════════════════════════════════════════════╝";
    ...
    public void ShowMainMenu()
    {
        ...
        System.Console.WriteLine("6.  📦 Create SQLite Test Database");
        System.Console.WriteLine("7.  📊 Show Database Schemas");
        System.Console.WriteLine("8.  🔬 Query Analysis (SQL Generation)");
        System.Console.WriteLine("9.  🧪 Automatic Test Queries");
        System.Console.WriteLine("10. 🤖 Multi-Database Query (AI)");
        System.Console.WriteLine("11. 🤖 Setup Ollama Models");
        System.Console.WriteLine("12. 📦 Test Vector Store (InMemory/FileSystem/Redis/SQLite/Qdrant)");
        System.Console.WriteLine("13. 📄 Upload Documents (PDF, Word, Excel, Images, Audio)");
        ...
        System.Console.WriteLine("18. 🧹 Clear Conversation History");
